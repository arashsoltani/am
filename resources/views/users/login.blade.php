                    ...
                    <div class="login-form login-signin py-11">
                        ...
                        <form class="form" novalidate="novalidate"  id="kt_login_signin_form">
                            ...
                            <div class="text-center pb-8">
                                ...
                                <span class="text-muted font-weight-bold font-size-h4">یا<a href="{{route('register.index')}}" class="text-primary font-weight-bolder" id="kt_login_signup"> ساخت حساب کاربری</a></span>
                            </div>
                            <!--end::Title-->
