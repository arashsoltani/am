                ...
                <div class="d-flex flex-column-fluid flex-column flex-center">
                    ...
                    <div class="login-form login-signup pt-11">
                        ...
                        <form class="form" method="POST" action="{{route('register.store')}}" novalidate="novalidate" id="kt_login_signup_form">
                            ...
                            <div class="form-group">
                                <input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg font-size-h6" type="number" placeholder="همراه" name="phone" autocomplete="off"/>
                            </div>


                            <div class="form-group">
                                <input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg font-size-h6" type="email" placeholder="پست الکترونیک" name="email" autocomplete="off"/>
                            </div>
